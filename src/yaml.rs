...
impl Doc {
    ...
    pub(crate) fn load(path: &Path) -> Result<&'static Doc> {
    ...
    pub(crate) fn node(&'static self) -> N<'static> {
        N {
            node: &self.root,
            file: &self.path,
        }
...
impl<'a> N<'a> {
    ...
    pub(crate) fn err(&self, msg: impl Into<String>) -> Diag {
    ...
    pub(crate) fn as_seq(&self) -> Result<Vec<N<'a>>> {
        match &self.node.data {
    ...
    pub(crate) fn as_map(&self) -> Result<Vec<(N<'a>, N<'a>)>> {
        match &self.node.data {
    ...
    pub(crate) fn keys(&self) -> Result<Vec<(&'a str, N<'a>)>> {
        self.as_map()?
            .into_iter()
    ...
    pub(crate) fn get(&self, key: &str) -> Option<N<'a>> {
    ...
    pub(crate) fn require(&self, key: &str) -> Result<N<'a>> {
        self.get(key)
    ...
    pub(crate) fn deny_unknown_keys(&self, allowed: &[&str], ctx: &str) -> Result<()> {
    ...
    pub(crate) fn as_scalar_string(&self) -> Result<String> {
        match &self.node.data {
